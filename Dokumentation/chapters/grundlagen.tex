...
Dabei wird auf die Themen Requirements Engineering, Augmented Reality und die Software reQlab eingegangen.
  ...
  \subsection{Head-Mounted Displays}
    ...
    \begin{figure}[H]
      ...
      \sourcecaption{Oculus Quest 3 VR-Headset}{https://unsplash.com/de/fotos/ein-mann-der-auf-einem-stuhl-sitzt-und-eine-virtuelle-brille-tragt-AZ-ND5uJ4S4}
  ...
  \begin{figure}[H]
    ...
    \sourcecaption{Innenraum des Mercedes-Benz Fahrsimulators}{https://group.mercedes-benz.com/innovation/produktinnovation/technologie/fahrsimulator.html}
    \label{fig:merc-sim}
  \end{figure}
